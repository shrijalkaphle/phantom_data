...
@section('content')
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
            <!-- ====== Chart One Start -->
            @include('User.dashboard.includes.chart01')
            <!-- ====== Chart One End -->

            <!-- ====== Chart Two Start -->
            @include('User.dashboard.includes.chart02')
            <!-- ====== Chart Two End -->

            <!-- ====== Chart Three Start -->
            @include('User.dashboard.includes.chart03')
            <!-- ====== Chart Three End -->

            <!-- ====== Map One Start -->
            @include('User.dashboard.includes.map01')
            <!-- ====== Map One End -->

            <!-- ====== Table One Start -->
            <div class="col-span-12 xl:col-span-8">
                @include('User.dashboard.includes.table01')
            </div>
            <!-- ====== Table One End -->
