        ...
        <div class="modal-content" style="background-color: #FFFFFF;"> <!-- Custom background color -->
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control-sm form-control" id="credits" placehoder="Enter Credits Amount" name="credits" required>
                </div>
                <button type="button" class="btn update-credits form-control form-control-sm"><span style="color:#A020F0">Update
                        Credits</span></button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="credits-update-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
...
<div class="modal fade" id="invalid-credits-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
    data-bs-backdrop="static" data-bs-keyboard="false">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control form-control-sm" id="password" name="user_password"
                            autocomplete="off">
...
<div class="modal fade" id="user-created-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
    data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="userUpdatedSuccess" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
    data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <label for="email" class="form-label" style="font-size:12px">Email</label>
                    <span class="email-error d-none" style="font-size:10px;color:#d9534f;font-weight:500"></span>
                    <input type="email" readonly class="form-control form-control-sm" id="email" name="email">
                </div>
...
<script>
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return '<div class="action-dots float-center">' +
                            ...
                            '<li><a class="dropdown-item view-user" href="#" data-id="' + row.id + '"><img src="{{url('web/assets/dashboard/images/icon/icon_18.svg')}}" alt="" class="lazy-img">Properties</a></li>' +
                            '<li><a class="dropdown-item add-credits" href="#" data-id="' + row.id + '"><img src="{{url('web/assets/dashboard/images/icon/icon_20.svg')}}" alt="" class="lazy-img">Add credits</a></li>' +
                            '<li><a class="dropdown-item edit-user" href="#" data-id="' + row.id + '"><img src="{{url('web/assets/dashboard/images/icon/icon_28.svg')}}" alt="" class="lazy-img">Edit</a></li>' +
                            '</ul>' +
                            '</div>';
                    }
                }
    ...
    function validateDataStepOne() {
        ...
        if (name && last_name && phone && phone.length == 15 && phone.match(phoneRegex) && email && isValidEmail(email) && password && password.length >= 8 && confirm_password && password == confirm_password && credits_rate) {
            // submitContactForm();
    ...
    $(document).on('click', '.view-user', function (e) {
        ...
        $.ajax({
            url: "{{ route('get-user-properties', ['user_id' => ':userId']) }}".replace(':userId', userId),
            method: 'GET',
            success: function (response) {
            ...
            success: function (response) {
                if (response.message === 'success') {
                    ...
                    if(userInfo.user_source == 'Register'){
                        ...
                        if(userInfo.user_source == 0.02 || userInfo.user_source == 0.03 || userInfo.user_source == 0.04 || userInfo.user_source == 0.05)
                    {
